				...
				<div class="container-fluid">
					...
					<div class="dashboard-section">
						<div class="section-heading clearfix">
							<h2 class="section-title"><i class="lnr lnr-cog"></i> Settings</h2>
						</div>
											...
											<div class="left">
												...
												<?php foreach ($res as $ad) : ?>	
													...
													if ($jum > 0) {
														...
														?>
														<input type="hidden" class="form-control" value="<?= $ad['nip']; ?>" name="nip">
														<?php
													}
													?>
													...
													<div class="form-group">
														<label>Email</label>
														<input type="email" class="form-control" value="<?= $ad['email']; ?>" name="email">
													</div>
													<div class="form-group">
														<label>Username</label>
														<input type="text" class="form-control" value="<?= $ad['username']; ?>" name="username" id="form-input" onclick="checkName()" maxlength="42">
													</div>
													<div class="form-group">
