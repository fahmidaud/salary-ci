...
<html>
<head>
	<title>Laporan Potongan Gaji - Pixel Salary</title>
...
<body id='data'>
	...
	<h3 align="center">PT. PIXEL SALARY<br>DAFTAR POTONGAN GAJI</h3>
	<hr>
	<?php
	...
	<table border="1" cellpadding="4" cellspacing="0" width="100%">
		...
		<tbody>
			...
			foreach ($query as $d) {
				...
				$potongan_ketidakhadiran = buatRP($d['potongan_sakit'] + $d['potongan_izin'] + $d['potongan_alpha']);
